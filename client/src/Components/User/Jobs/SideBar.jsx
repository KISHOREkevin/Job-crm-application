...
const SideBar = () => {
  ...
  return (
    <>
      {hidden ?
        <>
          <button onClick={sidebarTogglebutton} className='visible lg:hidden fixed m-3' ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          <div className='shadow-lg w-50  h-[100vh] hidden lg:block fixed bg-white ' >
            ...
            <NavLink>
              <ul className="flex flex-col  pt-10">
                <Link to="/user/home" className='hover:bg-blue-600 hover:text-white p-5'><li>Profile</li></Link>
                <Link to="/user/available-jobs" className='bg-blue-600 text-white p-5'><li>Available Jobs</li></Link>
